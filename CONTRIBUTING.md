...
[bug_tracker_opened_issues]: https://framagit.org/rdeville-public/dotfiles/awesome/issues/?sort=created_date&state=opened&or[label_name][]=Type%3A%3ABug&or[label_name][]=Type%3A%3ARegression&first_page_size=200
...
AwesomeRC, **including completely new features and minor improvements to
...
[issues_page]: https://framagit.org/rdeville-public/dotfiles/awesome/-/issues
...
- You may want to **include screenshots or screen recordings** which help you
  ...
  instance).
- **Explain why this enhancement would be useful** to most AwesomeRC users. You
...
[new_issues_page]: https://framagit.org/rdeville-public/dotfiles/awesome/-/issues/new
...
```text
[AwesomeRC] - Join The Project Team
```
...
[README]: https://framagit.org/rdeville-public/dotfiles/awesome/-/blob/main/README.md
[CODE_OF_CONDUCT]: https://framagit.org/rdeville-public/dotfiles/awesome/-/blob/main/CODE_OF_CONDUCT.md
[documentation]: https://framagit.org/rdeville-public/dotfiles/awesome
