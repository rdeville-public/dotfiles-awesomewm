...
local function factory(args)
  ...
  args.bar_shape = args.bar_shape or beautiful.disk_bar_shape
  ...
  local disk_bars = function()
    ...
    for idx = 1, #args.disks_value do
      ...
      local disk_template = wibox.widget({
        ...
        widget = wibox.container.margin(nil, 5, 5, 0, 0),
      })
  ...
  disk = wibox.widget({
    {
      ...
      widget = wibox.container.margin(nil, 20, 20, 0, 0),
    },
    bg = args.bg,
    shape = args.shape,
    ...
    set_disk_used = function(self, disk_stdout)
      ...
      for idx = 1, #disks_value do
        ...
        self:get_children_by_id("disk_bar_" .. idx).value =
          disks_value[idx].value
      end
    end,
  })
