...
-- Awesome-extra module libraries
-- ------------------------------------------------------------------------
-- Modular widgets library
...
-- Program
-- ------------------------------------------------------------------------
local terminal   = "st" or "lxterminal" or "xterm"
...
run_once({
  ...
  "ssh-agent",       -- SSH Agent to manage ssh identity
...
-- Client mouse button management
-- -----------------------------------------------------------------------------
awful.util.clientbuttons = awful.util.table.join(
  -- Right click activate focus and raise client
  awful.button({        }, 1, function (c) client.focus = c; c:raise() end),
  -- Modkey + Right click to move client
  awful.button({ modkey }, 1, awful.mouse.client.move),
  -- Modkey + Left click to resize client
  awful.button({ modkey }, 3, awful.mouse.client.resize)
)


-- Tag mouse button management
-- ------------------------------------------------------------------------
awful.util.taglist_buttons = awful.util.table.join(
  -- Right click of mouse activate clicked vdesktop
  awful.button({ }, 1, function(t) t:view_only() end),
  -- Left click of mouse show content of clicked vdesktop on current one
  awful.button({ }, 3, awful.tag.viewtoggle),
  -- Mouse scroll wheel switch to previous or next vdesktop
